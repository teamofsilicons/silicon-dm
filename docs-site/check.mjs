...
for(const page of pages){const html=await readFile(page,'utf8');if(!html.includes('rel="canonical" href="https://docs.dm.teamofsilicons.com/'))failures.push(`${page}: canonical`);
