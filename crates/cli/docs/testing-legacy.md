# Legacy DM testing environments

This is the compatibility guide for old manually paired environments. New environments use [automatic app-secret entry](testing-environments.md).
...
| Imported DM IAM app ID | Same canonical application ID, such as `dm` | No |
...
```sh
iam --test "$IAM_TEST_ID" app import 'dm'
```
